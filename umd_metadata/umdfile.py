...
# coding: utf8
#########################################################################
# Author: Xinyu.Xiang(zorrohunter@gmail.com), Thihy(my2003cat@gmail.com)
# File Name: umdfile.py
# Description: 
#########################################################################
import os
import datetime
...
class UMDFile(object):
    ...
    def _getCoverData(self):
        ...
        try:
            ...
            traceback.print_exc()
    CoverData=property(_getCoverData,None,None,'the cover data of the book')
    ...
    def _setPublishDate(self,value):
        self.publishDate = value;
    PublishDate=property(_getPublishDate,_setPublishDate,None,'timestamp,PublishDate')

    def read(self,ufile, metaOnly = False):
        '''
        ufile: binary file-like object(not close)
        '''
    ...
    def _readadditional(self,id,check,length,ufile):
        ...
        if id==0x0f:
            return
        self._readnone(ufile,length);
        return
        
    def _readnone(self,ufile,length):
